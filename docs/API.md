...
| `sourceAmount` | double | 业务源金额 |
| `ledgerAmount` | double | 账务金额 |
| `transactionCount` | int | 交易笔数 |
| `matchedCount` | int | 匹配笔数 |
| `unresolvedExceptions` | int | 未解决差异数 |
| `counterpartConfirmed` | boolean | 对方已确认 |
| `invoiceReady` | boolean | 发票资料齐备 |
| `bankAccountVerified` | boolean | 收款账户已验证 |
