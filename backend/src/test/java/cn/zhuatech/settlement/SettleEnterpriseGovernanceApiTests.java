...
class SettleEnterpriseGovernanceApiTests {
    ...
    void batchWorkflowIsAtomicAuditableAndFilterable() throws Exception {
        long first = create("GOV-SETTLE-001", "gov-settlement-001", "ZH-BJ", "2026-11");
        long second = create("GOV-SETTLE-002", "gov-settlement-002", "ZH-BJ", "2026-11");
    ...
    void fiscalPeriodLockPreventsBusinessMutationUntilAdminUnlocks() throws Exception {
        ...
        mvc.perform(post("/api/enterprise/controls")
                .with(httpBasic("operator", "operator123"))
                .contentType(MediaType.APPLICATION_JSON)
                .content(body("GOV-SETTLE-LOCKED", "gov-settlement-locked", "ZH-GZ", "2026-12")))
        ...
        mvc.perform(post("/api/enterprise/controls")
                .with(httpBasic("operator", "operator123"))
                .contentType(MediaType.APPLICATION_JSON)
                .content(body("GOV-SETTLE-UNLOCKED", "gov-settlement-unlocked", "ZH-GZ", "2026-12")))
            .andExpect(status().isOk());
    }
